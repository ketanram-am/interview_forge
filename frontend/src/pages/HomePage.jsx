...
<div className="stats stats-vertical lg:stats-horizontal bg-base-100 shadow-lg">
  <div className="stat">
    <div className="stat-value text-primary">Forge</div>
    <div className="stat-title">Coding Skills</div>
  </div>

  <div className="stat">
    <div className="stat-value text-secondary">Practice</div>
    <div className="stat-title">Interviews</div>
  </div>

  <div className="stat">
    <div className="stat-value text-accent">Build</div>
